...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/🦊Tomoya Hirano/Stringtail'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '🦊Tomoya Hirano' => 'tomoya.hirano@dena.com' }
  s.source           = { :git => 'https://github.com/🦊Tomoya Hirano/Stringtail.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'Stringtail' => ['Stringtail/Assets/*.png']
  # }
